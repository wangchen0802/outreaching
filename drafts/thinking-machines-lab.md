...
Saw most of Inkling's post-training compute went to RL on synthetic and human-built environments, and we'd like to supply human-built ones for code and autoresearch. I'd like to understand where you're short: which domains, which formats (SFT, preference data, rubrics, RL tasks, evals), and what volume and turnaround you need. We can start with a small paid pilot: high-quality data at a competitive price.
