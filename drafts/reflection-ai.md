...
Saw Reflection is hiring a data partnerships lead ahead of your first open-weight release, and we'd like to be one of those partners for agentic RL environments. I'd like to understand where you're short: which domains, which formats (SFT, preference data, rubrics, RL tasks, evals), and what volume and turnaround you need. We can start with a small paid pilot: high-quality data at a competitive price.
