...
Saw QuantumBlack now builds client agents alongside Google's engineers, and we'd like to help build the expert evals those agents have to pass. I'd like to understand where you're short: which domains, which formats (SFT, preference data, rubrics, RL tasks, evals), and what volume and turnaround you need. We can start with a small paid pilot: high-quality data at a competitive price.
