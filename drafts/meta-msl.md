...
Saw Muse Spark's health data was curated with 1,000+ physicians, and we'd like to help bring the same depth to law and finance. I'd like to understand where you're short: which domains, which formats (SFT, preference data, rubrics, RL tasks, evals), and what volume and turnaround you need. We can start with a small paid pilot: high-quality data at a competitive price.
